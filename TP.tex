...
Les travaux pratiques qui suivent vise à vous aider à mieux appréhender 
les méthodes de raisonnements et les outils de programmation. 
Ceux-ci étant largement indispensable à la pratique des sciences à
haut niveau, dans laquelle il est souvent indispensable
...
Chaque TP aborde des notions simples de mathématique à aborder avec 
les éléments les plus simples de Python. Le tout est conçu pour vous
...
%\include{tp_derivation/exercices/enonce.tex}
%\input{tp_derivation/exercices/enonce.tex}
